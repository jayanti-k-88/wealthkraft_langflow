...
class ExtractInvestmentParams(Component):
    display_name = "Extract Investment Parameters"
    ...
    outputs = [
        Output(name="investment_data", display_name="Investment Data", method="extract_data"),
    ]
